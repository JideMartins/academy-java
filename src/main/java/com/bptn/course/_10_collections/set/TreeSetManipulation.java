...
public class TreeSetManipulation {
	...
	public static void main(String[] args) {
		...
		System.out.println("First element: " + ((TreeSet<Character>) set).first());


        // Use the last() method to get the last element in the set, then print it out.
		System.out.println("Last element: " + ((TreeSet<Character>) set).last());


        // Use the headSet() method to get the elements in the set that are strictly less than the element B.
		System.out.println("Elements less than 'B': " + ((TreeSet<Character>) set).headSet('B'));

        
        // Use the tailSet() method to get the elements in the set that are greater than or equal to B.
		System.out.println("Elements greater than or equal to 'B': " + ((TreeSet<Character>) set).tailSet('B'));
		...
		System.out.println("Elements between 'A'(inclusive) and 'C'(exclusive): " + ((TreeSet<Character>) set).subSet('A','C'));
