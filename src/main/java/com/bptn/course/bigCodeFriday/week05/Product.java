...
public class Product {
	...
	public static long countProducts(List<Product> productsList) {
		...
		return productsList.stream().filter(product -> product.price < 30_000).count();
	}
	...
	/**
	 * The product class has instance variables id, name and price that is initialized by the constructor
	 * the countProducts method uses the streams to filter and count products with price less than 30,000
	 */
